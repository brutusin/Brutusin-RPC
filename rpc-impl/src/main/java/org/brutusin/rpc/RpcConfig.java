...
public final class RpcConfig {
    ...
    private RpcConfig() {
        ...
        this.serverUriEncoding = getEnv(PROP_SERVER_URI_ENC, defUriEncoding);
        ...
        this.includeBuiltinServices = Boolean.valueOf(getEnv(PROP_INCLUDE_BUITIN_SERVICES, "true"));
        this.includeEnvService = Boolean.valueOf(getEnv(PROP_INCLUDE_SERVICE, "true"));
        this.testMode = Boolean.valueOf(getEnv(PROP_TEST_MODE, "false"));
        this.linkSourceCode = Boolean.valueOf(getEnv(PROP_LINK_SOURCE_CODE, "false"));
