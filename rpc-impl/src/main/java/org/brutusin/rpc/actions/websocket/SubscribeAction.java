 ...
 */
@Description("**Subscribes** current websocket session to the specified topic.")
public class SubscribeAction extends WebsocketAction<TopicIdInput, Void>{
    ...
    public Void execute(TopicIdInput input) throws InvalidSubscriptionException {
        ...
        Object obj = WebsocketActionSupport.getInstance().getSpringContext().getBean(input.getId());
