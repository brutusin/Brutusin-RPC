 ...
 */
@Description("**Unsubscribes** current websocket session from the specified topic. *[See action source code at [github](https://github.com/brutusin/rpc/blob/master/src/main/java/org/brutusin/rpc/actions/websocket/UnsubscribeAction.java)]*")
