...
JEE web microframework for creating thin server architectures in [Single-page applications](https://en.wikipedia.org/wiki/Single-page_application) offering:
